...
const _hoisted_2 = /*#__PURE__*/vue.createElementVNode("span", { class: "vgt-loading__content" }, " Loading... ", -1 /* HOISTED */);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_vgt_pagination = vue.resolveComponent("vgt-pagination");
  const _component_vgt_global_search = vue.resolveComponent("vgt-global-search");
  const _component_vgt_table_header = vue.resolveComponent("vgt-table-header");
  const _component_vgt_header_row = vue.resolveComponent("vgt-header-row");
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", {
      class: vue.normalizeClass(["vgt-inner-wrap", { 'is-loading': $props.isLoading }])
    }, [
      (_ctx.paginate && _ctx.paginateOnTop)
        ? vue.renderSlot(_ctx.$slots, "pagination-top", {
            key: 0,
            pageChanged: $options.pageChanged,
            perPageChanged: $options.perPageChanged,
            total: $props.totalRows || $options.totalRowCount
          }, () => [
            vue.createVNode(_component_vgt_pagination, {
              ref: "paginationTop",
              ...
              vue.createVNode(_component_vgt_table_header, {
                ...
                "table-column": vue.withCtx((slotProps) => [
                  vue.renderSlot(_ctx.$slots, "table-column", {
                    ...
                    vue.createElementVNode("span", null, vue.toDisplayString(slotProps.column.label), 1 /* TEXT */)
                  ])
                ]),
                "column-filter": vue.withCtx((slotProps) => [
                  vue.renderSlot(_ctx.$slots, "column-filter", {
      ...
      vue.createElementVNode("div", {
        class: vue.normalizeClass({ 'vgt-responsive': $props.responsive }),
		        ...
		        onAuxclick: $event => ($options.onRowAuxClicked(row, index, $event))
                  ...
                  (row['expanded'])
                    ? (vue.openBlock(), vue.createElementBlock("tr", {
                        ...
                        vue.createElementVNode("td", { colspan: $options.fullColspan }, vue.toDisplayString(row["expandedRow"]), 9 /* TEXT, PROPS */, _hoisted_15)
                      ]))
                    : vue.createCommentVNode("v-if", true)
                ], 64 /* STABLE_FRAGMENT */))
              }), 256 /* UNKEYED_FRAGMENT */)),
      ...
      (_ctx.paginate && _ctx.paginateOnBottom)
        ? vue.renderSlot(_ctx.$slots, "pagination-bottom", {
            key: 3,
            pageChanged: $options.pageChanged,
            perPageChanged: $options.perPageChanged,
            total: $props.totalRows || $options.totalRowCount
